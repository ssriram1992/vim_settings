...
nnoremap <F9> :!g++ % -I/opt/eigen -I/opt/gurobi/gurobi801/linux64/include/ -L/opt/gurobi/gurobi801/linux64/lib -lgurobi_c++ -lgurobi80 -lm -I /opt/armadillo-code/include -lblas -llapack -O2   -o %:r<CR>
nnoremap <C-F9> :!./%:r<CR>
